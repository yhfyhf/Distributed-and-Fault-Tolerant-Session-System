...
public class Conf {
    ...
    public static final int W = 3;   // sends write requests to W distinct servers
    public static final int WQ = 3;  // waits for at least WQ responses
    public static final int R = 3;   // sends read requests to R servers randomly chosen from WQ servers
